...
In this experiment, we set duty-cycle be 0.7 and intensity be 50\%. The experimental paradigm is shown in Table 7.2, we set the flickering type, sample length, epoch time, duty cycle, intensity and frequency to be the same. There are some different in stimulus. We have 2 experiment of stimulus first is regular, regular means a flicker will blink 1 time per LED that is shown in Figure 7.6. Modulus means a flicker will blink 3 times for each LED that is shown in Figure 7.7. We will do this in 3, 5, 7 and 9 trails for each subject to obtain the EEG and average the data to get the accuracy of this experiment.
