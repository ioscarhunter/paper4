...
\begin{table}[ht]
\centering
\begin{tabular}{| m{.1\linewidth} | m{.3\linewidth} | m{.2\linewidth} | m {.2\linewidth}}
			
			\hline 
			\multicolumn{1}{|c}{\textbf{Trial}} & 
  			\multicolumn{1}{|c|}{\textbf{Total time for each trials}}  & 
            \multicolumn{2}{c}{Accuracy of flickering type} \\
			\hline 
			Flickering type & Regular & Uniform random   \\
			\hline 
