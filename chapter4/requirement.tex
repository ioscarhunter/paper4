...
\begin{figure}[ht]
\centering \includegraphics[scale=0.5,bb = 0 0 200 100, draft, type=eps]{chapter4/uc.pdf}
...
\begin{itemize}
\item \textbf{Expanded description of the ��Know the EEG-headset status
use case }
...
\hline 
cell1 dummy text dummy text dummy text & cell2  &  &  &  &  & \tabularnewline
\hline 
...
\begin{figure}[ht]
\centering \includegraphics[scale=0.295,bb = 0 0 200 100, draft, type=eps]{chapter4/Rest.pdf}
...
\begin{figure}[ht]
\centering \includegraphics[scale=0.295,bb = 0 0 200 100, draft, type=eps]{chapter4/av_ERP.pdf}
...
\begin{figure}[ht]
\centering \includegraphics[scale=0.295,bb = 0 0 200 100, draft, type=eps]{chapter4/av_SSVEP.pdf}
