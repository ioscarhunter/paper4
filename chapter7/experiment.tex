...
\label{table:3}
\end{table}
\hspace{1.5cm} From the figure 7.6, we got the EEG data of flickers line Y1,Y3,Y5 and Y7 for experiment I from trial= 3, the subject is "OK". When we got the EEG data like the figure 7.6 of each flicker, we use range in 290-350 millisecond to classify what flicker that subject fixate. From figure 7.6 we will see there are 4 lines of graph Y1 is EEG data from flicker 1, Y3 is from flicker 2, Y5 is from flicker3, Y7 is from flicker 4, each line means we collect the data of the subject 3 trials and average the EEG data that we got in each line. When we have already computed the average it, we use the normalization in all of the data which be averaged to compare with each other. In this figure, the flicker that subject fixate is Y5 or flicker 3.
