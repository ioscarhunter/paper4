...
\hspace{1.5cm}low pass filer is only allow the frequency signal that is below  cut-off frequency
\subsection{High pass filter}
\hspace{1.5cm}high pass filter is only allow the frequency signal that is higher than cut-off frequency
\subsection{Band pass filter}
\hspace{1.5cm}band pass filter is only allow the frequency signal that is in the specified range
