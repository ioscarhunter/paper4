...
\begin{figure}[ht]
	...
	\caption{The application with visual stimulator, each visual stimulus target are associated with a function. In the figure the top center visual stimulus is associated with the green function which will open the music page. }
\end{figure}
