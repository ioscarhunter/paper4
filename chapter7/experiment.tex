...
From the figure\ref{fig:method}, we use this method in our experiment. We have 2 states of this experiment. The first state is resting state, we use this state to obtain the EEG of subject to be the baseline. In this state, we obtain the EEG of subject for 6 seconds. When we have investigated the baseline, we use Fourier transform to obtain the frequency spectrum and use smoothing filter to get smoothed baseline spectrum. The next state is active state. In this state, we obtain the EEG of subject 
