...
\begin{figure}[h]
	\centering
  	\includegraphics[scale = 0.4]{chapter3/21.pdf}
...
\begin{figure}[h]
	\centering
  	\includegraphics[scale = 0.5]{picture/23.pdf}
...
\newpage
2.2.4	Validation of the Emotiv EPOC® EEG gaming system for measuring research quality auditory ERPs\cite{val}
...
\begin{figure}[h]
	\centering
  	\includegraphics[scale = 0.75]{picture/24.pdf}
...
2.2.5 c-VEP Brain-Computer Interface (BCI)\cite{onl}
...
\begin{figure}[h]
	\centering
  	\includegraphics[scale = 0.5]{picture/25.pdf}
...
2.2.6	Human EEG responses to 1-100 Hz flicker\cite{hum}
...
\begin{figure}[h]
	\centering
  	\includegraphics[scale = 0.25]{picture/26.pdf}
...
\begin{figure}[h]
	\centering
  	\includegraphics[scale = 0.25]{picture/27.pdf}
