...
Windows function
Windows function is the mathematical function that use to improve artifacts of the Fourier transform by dividing the large time signal
into a small subset of the total signal.
