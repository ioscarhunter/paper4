...
\hspace{1.5cm}The windows application program to illustrate the use of SSVEP and ERPs, giving the feedback to subject. The user interface are design for easy to use. There are four main command which associated to the visual stimulator, up, down, left, right. in tthere are four main function of the program, music 
