...
The Fourier transform is the mathematical model which uses to transform from the time signal into the frequency domain. Every signal can be broken down into a combination of trigonometric function. 
\begin{figure}[ht]
	\centering
