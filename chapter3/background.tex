...
\subsection{Alpha band $\alpha$} The frequency range between 8-12 Hz. It occurs during the situation that our mind calm,so we can obtain the strongest EEG brain signal in this frequency range.
\begin{figure}[ht]
	\centering
...
\subsection{Beta band $\beta$} The frequency range between 12-30 Hz. We can investigate this band at the situation of memory and problem-solving.
\begin{figure}[ht]
	\centering
...
\subsection{Gamma band $\gamma$} The frequency range between 30-100 Hz. This wave may be implicated in creating the unity of conscious perception. 
\begin{figure}[ht]
	\centering
