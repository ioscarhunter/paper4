...
\hline 
1. Subject asks admin to access the system & _  \tabularnewline
\hline 
2. Subject is equipped the Emotiv headset by admin  & _  \tabularnewline
\hline 
_ & 3. The system returns the EEG-headset status (Green light) to admin \tabularnewline
\end{tabular*}
}
