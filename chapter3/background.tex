...
\hspace{1.5cm} Fast Fourier transform (FFT) is a algorithm to perform Fourier transform, Which reduce complexity of DFT  from $O(n^2)$ to $O(n \log n)$ where $n$ is data size.
