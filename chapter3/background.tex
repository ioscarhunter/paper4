...
\begin{figure}[ht]
	\centering
	\includegraphics[scale = 0.75]{chapter3/Eeg_delta.pdf}
	\caption{Delta Band}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale = 0.75]{chapter3/Eeg_theta.pdf}
	\caption{Theta Band}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale = 0.75]{chapter3/Eeg_alpha.pdf}
	\caption{Alpha Band}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale = 0.75]{chapter3/Eeg_beta.pdf}
	\caption{Beta Band}
\end{figure}
