...
The result of this experiment is shown in Table 7.2 with same set of parameter for each stimulus, sample length, epoch time, duty cycle, intensity and frequency. From the Table 7.2 we found each subject have better accuracy in uniform random than regular of flickering type We 
\newpage
