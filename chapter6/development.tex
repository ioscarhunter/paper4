...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{chapter6/sch.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{chapter6/component.pdf}
	\caption{Component of visual stimulator assemble with part number from ~\ref{fig:sch} }
\end{figure}
