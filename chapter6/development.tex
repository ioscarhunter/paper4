...
\hspace{1.5cm}The windows application program to illustrate the use of SSVEP and ERPs, giving the feedback to subject.  function of the program TheTThe user interface are design for easy to use.  There is four command in each page. 
