...
\subsubsection{Delta band} the lowest frequency in the range of 0-3 Hz. It occurs during deep sleep

\subsubsection{Theta band} the frequency range between 4-7 Hz. We can investigate the situation of intuitive,creative and imagery. 

\subsubsection{Alpha band} the frequency range between 8-12 Hz. It occurs during the situation that our mind calm,so we can obtain the strongest EEG brain signal in this frequency range.

\subsubsection{Beta band} the frequency range between 12-30 Hz. We can investigate this band at the situation of memory and problem-solving.

\subsubsection{Gamma band}the frequency range between 30-100 Hz. This wave may be implicated in creating the unity of conscious perception. 
